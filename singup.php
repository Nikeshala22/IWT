...
if(isset($_POST['submit'])){
   ...
   if(mysqli_num_rows($select) > 0){
      ...
      if($pass != $cpass){
         ...
         $insert = mysqli_query($con, "INSERT INTO `user_from` (name, email, number, address, password) VALUES ('$name', '$email', '$number', '$address', '$pass')") or die('Query failed: ' . mysqli_error($con));
